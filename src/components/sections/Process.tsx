...
const pillars = [
  { t: "Atmosphere", d: "Every track starts with a room, a light, a feeling — before a single sound." },
  { t: "Groove", d: "Pocket-first. The body moves before the mind catches up." },
  { t: "Emotion", d: "Melody as a slow burn. Restraint as a tool." },
  { t: "Brazilian Roots", d: "Rhythms, slang and soul carried from home into every set." },
  { t: "Organic Percussion", d: "Live hands, wood, skin. Texture you can almost touch." },
  { t: "Storytelling", d: "A set is an arc — sunrise to peak to silence." },
];
  ...
  return (
    <section id="process" className="relative py-32 sm:py-40 px-6 sm:px-10">
      <div className="mx-auto max-w-7xl">
        ...
        >
          <span className="text-overline">04 / Process</span>
