...
const translations: Translations = {
  "pt-BR": {
    ...
    "atmosphere.overline": "02 / Atmosfera",
    "atmosphere.title": "Onde o groove, a atmosfera e o movimento se tornam um.",
    "process.overline": "04 / Processo",
    "process.title": "Seis pilares, uma linguagem.",
    ...
    "live.overline": "03 / Lancamentos",
    "live.title": "Construido para presenca.",
    "live.description": "Uploads oficiais recentes do SoundCloud do catalogo FEEL HIGH.",
    "contact.overline": "05 / Contato",
    "contact.title": "Vamos criar momentos atraves da musica.",
    "footer.genre":
  ...
  en: {
    ...
    "atmosphere.overline": "02 / Atmosphere",
    "atmosphere.title": "Where groove, atmosphere and movement become one.",
    "process.overline": "04 / Process",
    "process.title": "Six pillars, one language.",
    ...
    "live.overline": "03 / Releases",
    "live.title": "Built for presence.",
    "live.description": "Recent official SoundCloud uploads from the FEEL HIGH catalog.",
    "contact.overline": "05 / Contact",
