...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "FEEL HIGH — Music for sunsets and dancefloors" },
      {
        name: "description",
        content:
          "FEEL HIGH is a cinematic music project blending tech house, melodic, afro and Brazilian roots. Listen to selected works and book sessions worldwide.",
      },
